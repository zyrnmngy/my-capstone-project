...
try {
    $sql = "
        SELECT u.id, u.full_name, u.username, u.email, u.id_number, u.created_at,
...
<body>
            ...
            <div class="container">
                ...
                <div class="filter-section">
                    <form method="GET" class="row">
                        ...
                        <div class="col-12">
                            <a href="manage-students" class="btn btn-outline-secondary">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            ...
                                            <button class="btn btn-sm btn-warning" onclick="resetPassword(<?php echo $student['id']; ?>, '<?php echo htmlspecialchars($student['full_name']); ?>')" title="Reset Password">
    ...
    <script>
        ...
        function resetPassword(studentId, studentName) {
            ...
            document.getElementById('modalBody').innerHTML = `Are you sure you want to reset the password for <strong>${studentName}</strong>? The new password will be "temp123".`;
            document.getElementById('confirmStudentId').value = studentId;
        ...
        function viewStudent(studentId) {
            ...
            window.location.href = `view-student?id=${studentId}`;
        }
