...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="teacher-requests" class="active"><i class="fas fa-user-clock"></i> Teacher Requests</a></li>
        ...
        <div class="main-content">
            <nav class="navbar">
                <div class="nav-content">
                    <div class="logo">Teacher Requests</div>
            ...
            <div class="container">
                ...
                <div class="content-section">
                    <div class="section-title">
                        <i class="fas fa-user-clock"></i> Pending Teacher Requests (<?php echo count($pending_teachers); ?>)
                    </div>
                    <div class="card-body">
    ...
    <script>
        ...
        function rejectTeacher(teacherId, teacherName) {
            document.getElementById('modalTitle').textContent = 'Reject Teacher';
            document.getElementById('modalBody').innerHTML = `Are you sure you want to reject <strong>${teacherName}</strong>? This action cannot be undone and will delete their account.`;
            document.getElementById('confirmTeacherId').value = teacherId;
        ...
        function viewTeacher(teacherId) {
            ...
            fetch('get-teacher-details?id=' + teacherId)
                ...
                .then(data => {
                    if (data.success) {
                        document.getElementById('teacherDetails').innerHTML = `
                            ...
                            <div style="margin-bottom: 1rem;"><strong>Email:</strong> ${data.teacher.email || 'N/A'}</div>
                            ...
                            <div style="margin-bottom: 1rem;"><strong>Status:</strong> <span class="badge badge-pending">Pending Approval</span></div>
                        `;
                    } else {
