...
if (!isset($_SESSION['admin_logged_in']) || !$_SESSION['admin_logged_in']) {
    header('Location: admin');  // Remove .php extension
    exit;
}
...
try {
    $sql = "
        SELECT u.id, u.full_name, u.username, u.email, u.id_number, u.user_type, u.created_at, u.temp_password,
               CASE 
    ...
    if ($search) {
        $sql .= " AND (u.full_name LIKE ? OR u.username LIKE ? OR u.id_number LIKE ? OR u.email LIKE ?)";
        $search_param = "%$search%";
        $params[] = $search_param;
        $params[] = $search_param;
        $params[] = $search_param;
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="all-users" class="active"><i class="fas fa-users"></i> All Users</a></li>
            ...
            <div class="container">
                ...
                <div class="filter-section">
                    <form method="GET" class="row">
                        ...
                        <div class="col-12">
                            <a href="all-users" class="btn btn-outline-secondary">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            ...
                                            <?php if ($user['user_type'] === 'teacher'): ?>
                                                <a href="manage-teachers" class="btn btn-sm btn-success" title="Manage in Teachers">
                                                    <i class="fas fa-chalkboard-teacher"></i>
                                                </a>
                                            <?php else: ?>
                                                <a href="manage-students" class="btn btn-sm btn-primary" title="Manage in Students">
    ...
    <script>
        ...
        function viewProfile() {
            alert('Admin Profile:\n\nUsername: <?php echo htmlspecialchars($_SESSION['admin_username'] ?? 'Admin'); ?>\nRole: Administrator');
        }
